...
const createProjectTool = tool(
        ...
        try {
            ...
            if (preset) {
                ...
                if (presetData) {
                    projectData = {
                        ...presetData,
                        ...project, // Project data overrides preset
    ...
    {
        name: 'createProject',
        description: 'Create a new project by sending project data to the projects endpoint. Can use presets like "social:instagram-post" for predefined sizes.',
        schema: z.object({
            project: ProjectSchema.describe('The project data with title, canvas size, pages, and other properties'),
            preset: z.string().optional().describe('Optional preset in format "category:key" like "social:instagram-post"'),
